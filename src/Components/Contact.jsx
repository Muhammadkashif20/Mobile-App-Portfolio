...
const Contact = () => {
  ...
  const whatsappNumber = "03122701346"; 
...
>
  ...
  <FaWhatsapp className="text-xl group-hover:scale-110 duration-300" />
          ...
          {/* ===== RIGHT SIDE ===== */}
          <div className="bg-white/5 border border-white/10 rounded-[36px] p-8 sm:p-10 backdrop-blur-2xl">
            ...
            {/* Send Button */}
            <button className="group mt-7 w-full bg-cyan-400 text-black py-4 rounded-2xl font-semibold flex items-center justify-center gap-3 hover:scale-[1.02] duration-300 shadow-[0_10px_40px_rgba(34,211,238,0.25)]">
